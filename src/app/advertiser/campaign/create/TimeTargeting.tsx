    ...
    <div className="w-full space-y-3 mt-6">
      <div className="rounded-md border border-gray-300 bg-blue-50 p-4">
        ...
        <div className="mt-3 overflow-x-auto rounded-md border border-gray-200 bg-white">
          <div className="grid grid-cols-[auto_repeat(24,1fr)] gap-1 p-3 text-xs min-w-max">
            ...
            return (
              <div key={day} className="contents">
                <button
                  ...
                  className={`h-8 flex items-center justify-center font-medium border-r pr-2 transition-colors ${
                    isDayFullySelected 
                ...
                {hours.map(hour => {
                  ...
                  return (
                    <button
                      ...
                      className={`h-8 w-full rounded-[2px] border border-gray-200 transition-colors ${
                        isSelected 
        ...
        <p className="mt-3 text-sm text-gray-600">
          Time targeting uses Pacific Time (PT) timezone. Click day names to
          select/deselect entire days, or click individual hours.
        </p>
      </div>
