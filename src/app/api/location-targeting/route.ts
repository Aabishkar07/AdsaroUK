...
export async function POST(req: Request) {
  try {
    console.log("🚀 LOCATION-TARGETING API ROUTE CALLED");
    ...
    console.log("📥 External API response body3:", JSON.stringify(result, null, 2));
    ...
    console.error("❌ ERROR IN LOCATION-TARGETING ROUTE:", error);
